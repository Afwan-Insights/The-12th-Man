...
3. **Proactive Push Notifications:** Transitioning the web application into a full PWA (Progressive Web App) to utilize WebSockets, allowing the system to actively push rerouting alerts to fans' lock screens if a gate suddenly becomes 
